...
public class TelaScoutingOld extends Activity {
	...
	private Context context = TelaScoutingOld.this;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tela_scouting_old);
		...
		final LazyAdapter jogadorLista = new LazyAdapter(TelaScoutingOld.this, jogadores);
		...
		btTempo.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Toast.makeText(TelaScoutingOld.this, R.string.tempo, Toast.LENGTH_SHORT).show();
				if(!cronometroTempo.isFinished()) {
					...
					cronometroTempo = new FinalCountdown(10000, 1000, false, 2, TelaScoutingOld.this);
					cronometroTempo.setText(cronosTempo);
					cronometroTempo.create();
					cronometroJogo.pause();
					cronosTempo.setVisibility(View.VISIBLE);
