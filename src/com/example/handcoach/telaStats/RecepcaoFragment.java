...
public class RecepcaoFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_recepcao, container, false);
		...
		violet = (ImageView) rootView.findViewById(R.id.violetaC2);
		
		blueV = (TextView) rootView.findViewById(R.id.jogador1C2);
		greenV = (TextView) rootView.findViewById(R.id.jogador2C2);
		orangeV = (TextView) rootView.findViewById(R.id.jogador3C2);
		redV = (TextView) rootView.findViewById(R.id.jogador4C2);
		violetV = (TextView) rootView.findViewById(R.id.jogador5C2);
		...
		chart = (LineChartView) rootView.findViewById(R.id.lineChart_recepcao);
	...
	private void generateData() {
		...
		for(int y = 0; y < numJog; y++) {	
			...
			for(int x = 0; x < tamanho; x++) {
				...
				rcp_certa = EventoDAO.getInstancia(getActivity()).retornaContadorQuery("SELECT * FROM evento WHERE id_cat = 7 AND id_jog="+listaJog.get(y).getId()+" AND id_ptda="+ultimasPartidas.get(x));
				rcp_rbdbola = EventoDAO.getInstancia(getActivity()).retornaContadorQuery("SELECT * FROM evento WHERE id_cat = 9 AND id_jog="+listaJog.get(y).getId()+" AND id_ptda="+ultimasPartidas.get(x));
